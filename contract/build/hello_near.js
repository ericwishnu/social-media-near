...
class Post {
  constructor(id, title, description, tags, media) {
    this.id = id;
    this.title = title;
...
let SocialMedia = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = view({}), _dec4 = call({}), _dec5 = call({}), _dec6 = view({}), _dec(_class = (_class2 = class SocialMedia {
  constructor() {
  ...
  like_a_post({
    ...
    var sender_id = predecessorAccountId();
...
}, (_applyDecoratedDescriptor(_class2.prototype, "add_post", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "add_post"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_all_posts", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "get_all_posts"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "like_a_post", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "like_a_post"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_my_liked_posts", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "get_my_liked_posts"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_posts_by_tag", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "get_posts_by_tag"), _class2.prototype)), _class2)) || _class);
function get_posts_by_tag() {
  let _state = SocialMedia._getState();
  if (!_state && SocialMedia._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  let _contract = SocialMedia._create();
  if (_state) {
    SocialMedia._reconstruct(_contract, _state);
  }
  let _args = SocialMedia._getArgs();
  let _result = _contract.get_posts_by_tag(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SocialMedia._serialize(_result));
}
function get_my_liked_posts() {
  let _state = SocialMedia._getState();
  if (!_state && SocialMedia._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  let _args = SocialMedia._getArgs();
  let _result = _contract.get_my_liked_posts(_args);
  SocialMedia._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SocialMedia._serialize(_result));
}
function like_a_post() {
  let _state = SocialMedia._getState();
  if (!_state && SocialMedia._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  let _args = SocialMedia._getArgs();
  let _result = _contract.like_a_post(_args);
  SocialMedia._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SocialMedia._serialize(_result));
}
function get_all_posts() {
  ...
  let _args = SocialMedia._getArgs();
  let _result = _contract.get_all_posts(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SocialMedia._serialize(_result));
}
function add_post() {
  let _state = SocialMedia._getState();
  ...
  let _args = SocialMedia._getArgs();
  let _result = _contract.add_post(_args);
  SocialMedia._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SocialMedia._serialize(_result));
}

export { add_post, get_all_posts, get_my_liked_posts, get_posts_by_tag, like_a_post };
